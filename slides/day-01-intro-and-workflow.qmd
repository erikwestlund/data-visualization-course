...
1. Everyone's computer works
2. Develop a basic understanding of the grammar of graphics and how `ggplot2` implements the concepts.
...
Visualization is not an add-on after the real analysis is done.

It is a crucial part of understanding data:
...
- **Flow**: how do things move through a process?
:::

## Take Notice

- These were presented as visualization types/aims.
- However, these really are basic scientific questions commonly asked.
- Let's look again.
...
::: {.incremental}
- **categorical data**: counts, composition, and rank
- **continuous data**: center, spread, shape, and outliers
- choosing plots from the question, not from a chart menu
:::
...
- This is the first time I've taught an expanded version of this course, so there will likely be adjustments in timing
- Likewise, I will be adjusting materials up to the class start time. I'll make sure any changes are communicated in class.
...
That matters because visualization is a process, not just a final image.
...
- I have found that there is now less learning value in being able to "make computer do things" and more in high level concepts
- In other words, you can focus on design and concepts and not implementation details
...
Before plotting, think about your level of measurement.

- what does one row represent?
- are rows people, places, events, months, or summaries?
...
| Geom | R Function | Stat/Transform | Use for |
|------|------------|-------------------|----------|
...
- Automatic `ggplot2` aggregations can fail when trying to do more difficult aggregations
- A powerful and frustration-reducing technique is to do the aggregation yourself (like in the last slide) and then use the `identity` mapping
...
- `modules/00-preclass_tech-check/02_setup-check.qmd`
- `modules/01-workflow-and-basics/02_first-visualization.qmd`
- `modules/01-workflow-and-basics/03_ggplot-basics.qmd`
...
- `practice/templates/01-workflow-and-basics/02_first-visualization-practice.qmd`
- `practice/templates/01-workflow-and-basics/03_ggplot-basics-practice.qmd`
- `practice/templates/01-workflow-and-basics/04_submission-check.qmd`
